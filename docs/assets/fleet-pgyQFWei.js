import{i as n,s as i,a as r}from"./layout-BbULftOu.js";document.addEventListener("DOMContentLoaded",()=>{n("fleet");const s=i.getBoats();document.getElementById("fleet-grid").innerHTML=s.map(e=>{const t=i.getOperatorById(e.operatorId),a=i.getMarinaById(e.marinaId);return`
