import{i as r,s as a,b as i}from"./layout-D7o9Jn7H.js";document.addEventListener("DOMContentLoaded",()=>{r("reviews"),document.getElementById("reviews-grid").innerHTML=a.getReviews().map(e=>{const t=a.getOperatorById(e.operatorId),s=a.getTripById(e.tripId);return`<article class="card review-card">
